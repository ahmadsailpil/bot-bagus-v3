...
let teks = 'gcbot'
let handler = async (m, { conn }) => conn.send2ButtonLoc(m.chat, await (await fetch('https://telegra.ph/file/5cd3cc7381bce4a4a65ec.jpg'+ teks)).buffer(), `

*𝐇𝐚𝐥𝐨 𝐁𝐚𝐧𝐡 𝐉𝐚𝐧𝐠𝐚𝐧 𝐋𝐮𝐩𝐚 𝐉𝐨𝐢𝐧 && 𝐁𝐚𝐜𝐚 𝐑𝐮𝐥𝐞𝐬❗*
╔═══════════════════
║ _*Group All*_  𝐑𝐈𝐃𝐇𝐎 𝐆𝐀𝐍𝐙 ×͜×
╠═══════════════════
║➸ 𝐆𝐫𝐨𝐮𝐩 𝐁𝐨𝐭 1
