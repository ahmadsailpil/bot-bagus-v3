...
const template = generateWAMessageFromContent(m.key.remoteJid, proto.Message.fromObject({
        listMessage: {
            title: `${ucapan()} ${name}`,
            description: menuu,
            buttonText: '𝐋𝐈𝐒𝐓 𝐁𝐔𝐘 𝐃𝐋 & 𝐒𝐄𝐋𝐋 𝐃𝐋',
            listType: 1,
            footerText: "𝐒𝐈𝐋𝐀𝐇𝐊𝐀𝐍 𝐏𝐈𝐋𝐈𝐇 𝐁𝐔𝐘 𝐀𝐓𝐀𝐔 𝐒𝐄𝐋𝐋 𝐃𝐋",
            mtype: 'listMessage',
            sections: [
              {
      
             "rows": [{
                  "title": ` BUY DIAMOND LOCK`,
                  "description": "HARGA BELI TERBARU",
                  "rowId": `.payment`
                },{
                  "title": 'SELL DIAMOND LOCK',
                  "description": "HARGA JUAL TERBARU",
                  "rowId": `.pilihanstore`
                 },{
                 "title": 'JASA MIDMAN',
                 "description": "100% DIJAMIN TRUSTED",
                  "rowId": `midman`
                 },{
              	"title": `INSTAGRAM OHLX STORE`,
                "description": "",
                  "rowId": `igohlx`
                 },{
              	"title": `DONASI BRO KALO LU SULTAN`,
                "description": "",
                  "rowId": `.donasi`
                }],
